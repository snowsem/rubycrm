...
/*!
 * Generated using the Bootstrap Customizer (http://bootstrap-3.ru/customize.php?id=ac0bcf86bbbf10dc20d7)
 * Config saved to config.json and https://gist.github.com/ac0bcf86bbbf10dc20d7
 */
    ...
    init: function(){
        ...
        function showResponse(responseText, statusText) {
            ...
            if (responseText == 'error') {
                ...
                window.location = '/contact/'+responseText;
            }
        };
        var options = {
            // элемент, который будет обновлен по ответу сервера
...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<input type="text" class="input-sm form-control" autocomplete="off"' +
