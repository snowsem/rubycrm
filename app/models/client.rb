class Client < ApplicationRecord
  ...
  paginates_per 100
  has_many :workplaces, :class_name => 'Workplace', primary_key: 'ClientId', foreign_key: 'wpClientId'
  ...
  has_many :contacts, class_name: 'Contact', primary_key: 'ClientId', through: :workplaces
